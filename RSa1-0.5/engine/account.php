...
class Account {
	...
	/*****************************************
	Function for process the class account
	*****************************************/	
	function Account() {
		global $session;
		if(isset($_POST['ft'])) {
	...
	*****************************************/	
	...
	/*****************************************
	Function to deleting an user account
	*****************************************/
	...
	*****************************************/
	private function Login() {
		...
		if($database->getUserField($_POST['user'],"banned",1) == "1") {
			$form->addError("banned",ACCOUNT_BANNED);
		}		
		if($form->returnErrors() > 0) {
			$_SESSION['errorarray'] = $form->getErrors();
			$_SESSION['valuearray'] = $_POST;
	...
	*****************************************/	
	...
	/*****************************************
	Function for the registration of a new village
	*****************************************/	
