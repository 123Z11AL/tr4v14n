...
function qst_handle(){if(quest.anmlock){
return false;}
quest.markup=false;
...
fd(fi(),function(mf){document.getElementById('popup3').innerHTML=mf.markup;
...
function qst_enter(jf){if(jf===undefined){
...
;}
pi();
fd(fi(),function(mf){for(var qd in mf){quest[qd]=mf[qd];}
}
,'POST',id
);
qst_wfm();
