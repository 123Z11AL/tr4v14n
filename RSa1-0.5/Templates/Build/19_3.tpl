...
echo "<tr><td class=\"desc\">
				...
				<td class=\"max\"><a href=\"#\" onClick=\"document.snd.t21.value=6; return false;\">(".$technology->maxUnit(21).")</a></td></tr></tbody>
				";
    if($technology->getTech(21)) {
        echo "<tbody><tr><td class=\"desc\"><div class=\"tit\">
            ...
            <td class=\"max\"><a href=\"#\" onClick=\"document.snd.t22.value=4; return false;\">(".$technology->maxUnit(22).")</a></td>
               </tr></tbody>";
    }
    ?>