...
<img class="building g21" src="img/x.gif" alt="<?php echo $lang['building'][21][0]; ?>" title="<?php echo $lang['building'][21][0]; ?>" /> </a>

<h1><?php echo $lang['building'][21][0]; ?> <span class="level">Level <?php echo $village->resarray['f'.$id]; ?></span></h1>
<p class="build_desc"><?php echo $lang['building'][21][1]; ?></p>
