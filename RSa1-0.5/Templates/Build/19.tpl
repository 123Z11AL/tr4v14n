<div id="build" class="gid19"><a href="#" onClick="return Popup(19,4);" class="build_logo">
	<img class="building g19" src="img/x.gif" alt="<?php echo $lang['building'][19][0]; ?>" title="<?php echo $lang['building'][19][0]; ?>" />
</a>
<h1><?php echo $lang['building'][19][0]; ?> <span class="level">level <?php echo $village->resarray['f'.$id]; ?></span></h1>
<p class="build_desc"><?php echo $lang['building'][19][1]; ?></p>
