...
<script language="JavaScript">var summe=<?php echo floor($village->awood+$village->acrop+$village->airon+$village->aclay); ?>;var max123=<?php echo $village->maxstore; ?>;var max4=<?php echo $village->maxcrop; ?>;</script> 
		...
		<p id="submitButton"> 
	<a href="javascript:document.snd.submit();">Trade resources at (step 2 of 2):</a><span class="none">(Costs: <img src="img/x.gif" class="gold_g" alt="Gold" title="Gold" /><b>3</b>)</span>	</p>
		<p id="submitText"></p> 
		</form> 
		<script> 
...
The first line shows the current stock. In the second line you can choose another distribution. The third line shows the difference between the old and new stock.</p></div>