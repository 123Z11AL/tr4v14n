<div id="build" class="gid17"><a href="#" onClick="return Popup(17,4);" class="build_logo"> 
	<img class="building g17" src="img/x.gif" alt="<?php echo $lang['building'][17][0]; ?>" title="<?php echo $lang['building'][17][0]; ?>" /> 
</a> 
<h1><?php echo $lang['building'][17][0]; ?> <span class="level">level <?php echo $village->resarray['f'.$id]; ?></span></h1> 
<p class="build_desc"><?php echo $lang['building'][17][1]; ?></p> 
...
<p class="error"><?php echo $form->getError("test"); ?></p>
