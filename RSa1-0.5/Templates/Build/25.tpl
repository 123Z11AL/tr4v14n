<div id="build" class="gid25"><a href="#" onClick="return Popup(25,4);" class="build_logo">
	<img class="building g25" src="img/x.gif" alt="<?php echo $lang['building'][25][0]; ?>" title="<?php echo $lang['building'][25][0]; ?>" />
</a>
<h1><?php echo $lang['building'][25][0]; ?> <span class="level">Level <?php echo $village->resarray['f'.$id]; ?></span></h1>
<p class="build_desc"><?php echo $lang['building'][25][1]; ?></p>
