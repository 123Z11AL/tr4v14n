<div id="build" class="gid8"><a href="#" onClick="return Popup(8,4);" class="build_logo">
	<img class="building g8" src="img/x.gif" alt="<?php echo $lang['building'][8][0]; ?>" title="<?php echo $lang['building'][8][0]; ?>" />
</a>
<h1><?php echo $lang['building'][8][0]; ?> <span class="level">Level <?php echo $village->resarray['f'.$id]; ?></span></h1>
<p class="build_desc"><?php echo $lang['building'][8][0]; ?></p>
