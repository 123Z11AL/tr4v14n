...
<form method="post" action="a2b.php">
			...
			<table class="troop_details" cellpadding="1" cellspacing="1">
				...
				<tbody class="units">
					<tr>
						<td></td>
						<td><img src="img/x.gif" class="unit u11" title="Legionario" alt="Legionario"></td>
                        <td><img src="img/x.gif" class="unit u12" title="Pretoriano" alt="Pretoriano"></td>
                        <td><img src="img/x.gif" class="unit u13" title="Imperano" alt="Imperano"></td>
                        <td><img src="img/x.gif" class="unit u14" title="Equites Legati" alt="Equites Legati"></td>
                        <td><img src="img/x.gif" class="unit u15" title="Equites Imperatoris" alt="Equites Imperatoris"></td>
                        <td><img src="img/x.gif" class="unit u16" title="Equites Caesaris" alt="Equites Caesaris"></td>
                        <td><img src="img/x.gif" class="unit u17" title="Carnero" alt="Carnero"></td>
                        <td><img src="img/x.gif" class="unit u18" title="Catapulta de fuego" alt="Catapulta de fuego"></td>
                        <td><img src="img/x.gif" class="unit u19" title="Senador" alt="Senador"></td>
                        <td><img src="img/x.gif" class="unit u20" title="Colono" alt="Colono"></td>
					</tr>
					<tr>
