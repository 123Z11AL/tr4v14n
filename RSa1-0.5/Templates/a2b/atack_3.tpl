...
<form method="post" action="a2b.php">
			...
			<table class="troop_details" cellpadding="1" cellspacing="1">
				...
				<tbody class="units">
					<tr>
						<td></td>
						<td><img src="img/x.gif" class="unit u21" title="Legionario" alt="Legionario"></td>
                        <td><img src="img/x.gif" class="unit u22" title="Pretoriano" alt="Pretoriano"></td>
                        <td><img src="img/x.gif" class="unit u23" title="Imperano" alt="Imperano"></td>
                        <td><img src="img/x.gif" class="unit u24" title="Equites Legati" alt="Equites Legati"></td>
                        <td><img src="img/x.gif" class="unit u25" title="Equites Imperatoris" alt="Equites Imperatoris"></td>
                        <td><img src="img/x.gif" class="unit u26" title="Equites Caesaris" alt="Equites Caesaris"></td>
                        <td><img src="img/x.gif" class="unit u27" title="Carnero" alt="Carnero"></td>
                        <td><img src="img/x.gif" class="unit u28" title="Catapulta de fuego" alt="Catapulta de fuego"></td>
                        <td><img src="img/x.gif" class="unit u29" title="Senador" alt="Senador"></td>
                        <td><img src="img/x.gif" class="unit u30" title="Colono" alt="Colono"></td>
					</tr>
					<tr>
...
<input name="t3" value="<?php echo $process[t3]; ?>" type="hidden"> <input name="t4" value="<?php echo $process[t4]; ?>" type="hidden"> 
<input name="t5" value="<?php echo $process[t5]; ?>" type="hidden"> 
<input name="t6" value="<?php echo $process[t6]; ?>" type="hidden"> <input name="t7" value="<?php echo $process[t7]; ?>" type="hidden"> 
<input name="t8" value="<?php echo $process[t8]; ?>" type="hidden"> 
<input name="t9" value="<?php echo $process[t9]; ?>" type="hidden"> <input name="t10" value="<?php echo $process[t10]; ?>" type="hidden"> 
