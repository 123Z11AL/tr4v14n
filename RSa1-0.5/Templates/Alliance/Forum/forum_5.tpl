			...
			<div bbArea="text" id="text_container" name="text_container">
				...
				<div id="text_toolbar" name="text_toolbar">
					...
					<div id="text_toolbarWindows">
						<div id="text_resources" name="text_resources"><a href="javascript:void(0);" bbType="o" bbTag="h" ><img src="img/x.gif" class="r1" title="Wood" alt="Wood" /></a><a href="javascript:void(0);" bbType="o" bbTag="l" ><img src="img/x.gif" class="r2" title="Clay" alt="Clay" /></a><a href="javascript:void(0);" bbType="o" bbTag="e" ><img src="img/x.gif" class="r3" title="Iron" alt="Iron" /></a><a href="javascript:void(0);" bbType="o" bbTag="g" ><img src="img/x.gif" class="r4" title="Wheat" alt="Wheat" /></a></div>
