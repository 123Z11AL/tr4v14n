...
?>
		<div class="clear dotted"></div><div class="text"><?php echo $arr[post]; ?></div></td>
	</tr>
<?php
foreach($posts as $po) {
...
echo '<div class="clear dotted"></div><div class="text">'.$po[post].'</div></td>
	</tr>';
}
?>
