...
if($_GET['admin']== "newforum"){
	...
	if($database->CheckForum($aid)){
		include("Forum/forum_2.tpl"); 
			...
			echo '<p class="error">There is still no forum created</p><p>
					<a href="allianz.php?s=2&admin=newforum"><img id="fbtn_newforum" class="dynamic_img" src="img/x.gif" alt="New forum" /></a></p></div>';
	}				
}