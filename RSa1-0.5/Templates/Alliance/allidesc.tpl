...
<tr>
<th>Tag</td><td class="s7"><?php echo htmlspecialchars($allianceinfo['tag']); ?></th>
<td rowspan="8" class="desc1"><textarea tabindex="1" name="be1"><?php echo htmlspecialchars($allianceinfo['desc']); ?></textarea></td>
</tr>

<tr>
<th>Name</th><td><?php echo htmlspecialchars($allianceinfo['name']); ?></td>
</tr>
...
<tr><td colspan="2" class="desc2"><textarea tabindex="2" name="be2"><?php echo htmlspecialchars($allianceinfo['notice']); ?></textarea></td></tr>
