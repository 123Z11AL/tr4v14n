	...
	<th colspan="4">
		...
		<div id="submenu">
			<a href="allianz.php?s=3">
				<img src="img/x.gif" class="btn_def active" alt="Defender" title="Defender" />
			</a>
...
<div id="stime">
	<div id="ltime">
		<div id="ltimeWrap">
						Calculated in <b>83</b> ms

						<br />Server time: <span id="tp1" class="b">4:29:34</span>
