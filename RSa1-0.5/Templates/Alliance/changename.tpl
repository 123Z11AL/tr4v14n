...
<tbody><tr>
<th>Tag</th>
<td><input class="tag text" name="ally1" value="<?php echo htmlspecialchars($allianceinfo['tag']); ?>" maxlength="8">
<span class="error2"></span></td>
</tr>

<tr>
<th>Name</th>
<td><input class="name text" name="ally2" value="<?php echo htmlspecialchars($allianceinfo['name']); ?>" maxlength="25">
<span class="error2"></span></td>
</tr></tbody></table>
