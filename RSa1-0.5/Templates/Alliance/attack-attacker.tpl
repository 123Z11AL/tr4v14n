...
<div id="textmenu">
   <a href="allianz.php">Overview</a>
 | <a href="allianz.php?s=2">Forum</a>
 | <a href="allianz.php?s=6">Chat</a>
 | <a href="allianz.php?s=3" class="selected ">Attacks</a>
 | <a href="allianz.php?s=4">News</a>

 | <a href="allianz.php?s=5">Options</a>
</div>
...
<tr>
	<th colspan="4">
		...
		<div id="submenu">
			...
			<a href="allianz.php?s=3">
				<img src="img/x.gif" class="btn_off active" alt="Attacker" title="Attacker" />
			</a>
		</div>
	</th>
</tr>
...
<div id="stime">
	<div id="ltime">
		<div id="ltimeWrap">
						Calculated in <b>115</b> ms

						<br />Server time: <span id="tp1" class="b">4:29:12</span>
