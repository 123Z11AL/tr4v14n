...
echo "<a href=\"statistiken.php?id=".$_GET['id']."&amp;rank=".($start-19)."\">&laquo; back</a>|<a href=\"statistiken.php?id=".$_GET['id']."&amp;rank=".($start+21)."\">forward &raquo;</a>";
}
else if($start == 1 && $start+20 < count($ranking)) {
    	echo "&laquo; back</a>|<a href=\"statistiken.php?id=".$_GET['id']."&amp;rank=".($start+21)."\">forward &raquo;</a>";
    }
    else if($start != 1 && $start+20 > count($ranking)) {
    	echo "<a href=\"statistiken.php?id=".$_GET['id']."&amp;rank=".($start-19)."\">&laquo; back</a>|forward &raquo;";
    }
    else {
