...
<table cellpadding="1" cellspacing="1" id="alliance_off" class="row_table_data">
			<thead>
				<tr>
					<th colspan="5">
						The best alliances (off)						<div id="submenu"><a title="Top 10" href="statistiken.php?id=47"><img class="btn_top10" src="img/x.gif" alt="Top 10" /></a><a title="defender" href="statistiken.php?id=42"><img class="btn_def" src="img/x.gif" alt="defender" /></a><a title="attacker" href="statistiken.php?id=4"><img class="active btn_off" src="img/x.gif" alt="attacker" /></a></div>		    
					</th>
				</tr>
