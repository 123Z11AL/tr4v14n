...
<table cellpadding="1" cellspacing="1" id="alliance_def" class="row_table_data">
			<thead>
				<tr>
					<th colspan="5">
						The best alliances (def)						<div id="submenu"><a title="Top 10" href="statistiken.php?id=47"><img class="btn_top10" src="img/x.gif" alt="Top 10" /></a><a title="defender" href="statistiken.php?id=4"><img class="active btn_def" src="img/x.gif" alt="defender" /></a><a title="attacker" href="statistiken.php?id=41"><img class="btn_off" src="img/x.gif" alt="attacker" /></a></div>		    
					</th>
				</tr>
        ...
        if(count($ranking->getRank()) > 0) {
            ...
            for($i=$start;$i<($start+20);$i++) {
            	if(isset($ranking[$i]['name']) && $ranking[$i] != "pad") {
                    ...
                    echo $ranking[$i]['players']."</td><td class=\"av \" >".$ranking[$i]['avg']."</td><td class=\"po \">".$ranking[$i]['totaldp']."</td></tr>";
                }
            }
        }
        else {
